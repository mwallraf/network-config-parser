...
if [[ -z $CARRIERETHERNET_PARSER_CONFIG_FOLDER ]]; then
  ...
  echo "CARRIERETHERNET_DB_FOLDER -> $CARRIERETHERNET_DB_FOLDER"
...
export CARRIERETHERNET_PARSER_DB_FOLDER
export CARRIERETHERNET_PARSER_LOGFILE
export CARRIERETHERNET_PARSER_OUTPUT_FOLDER
export CARRIERETHERNET_PARSER_DEBUG_FOLDER
export CARRIERETHERNET_PARSER_MAX_CONFIG_AGE
export MAX_PARSED_FILES
export CARRIERETHERNET_PARSER_MAX_CONFIG_AGE


echo "CARRIERETHERNET_PARSER_DIR: $CARRIERETHERNET_PARSER_DIR"
echo "CARRIERETHERNET_PARSER_CONFIG_FOLDER: $CARRIERETHERNET_PARSER_CONFIG_FOLDER"
echo "CARRIERETHERNET_PARSER_LOG_FOLDER: $CARRIERETHERNET_PARSER_LOG_FOLDER"
